...
+if host_platform == "win32" and sys.version_info >= (3, 11):
     import atexit
...
+    elif host_platform.startswith("freebsd"):
         ...
         expr = r".* => (.*)"
         env = {}
@@ -425,6 +428,38 @@ class pil_build_ext(build_ext):
...
+        elif host_platform == "cygwin":
             ...
             _add_directory(
                 library_dirs,
@@ -509,7 +544,7 @@ class pil_build_ext(build_ext):
                 ),
             )
...
@@ -557,13 +592,13 @@ class pil_build_ext(build_ext):
...
@@ -578,11 +613,11 @@ class pil_build_ext(build_ext):
                     ),
                 )
...
@@ -598,7 +633,7 @@ class pil_build_ext(build_ext):
             # alpine, at least
...
@@ -633,7 +668,7 @@ class pil_build_ext(build_ext):
...
@@ -641,7 +676,7 @@ class pil_build_ext(build_ext):
...
@@ -697,7 +732,7 @@ class pil_build_ext(build_ext):
...
@@ -815,7 +850,7 @@ class pil_build_ext(build_ext):
         if feature.jpeg2000:
...
@@ -826,7 +861,7 @@ class pil_build_ext(build_ext):
         if feature.tiff:
...
@@ -835,13 +870,13 @@ class pil_build_ext(build_ext):
         if feature.xcb:
...
@@ -879,7 +914,7 @@ class pil_build_ext(build_ext):
...
@@ -898,7 +933,7 @@ class pil_build_ext(build_ext):
         else:
...
@@ -915,7 +950,7 @@ class pil_build_ext(build_ext):
         print("-" * 68)
